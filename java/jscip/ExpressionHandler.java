...
public abstract class ExpressionHandler
{
   ...
   private final SWIGTYPE_p_SCIP_Exprhdlr _exprhdlrptr; /** pointer address class created by SWIG */
   ...
   private static boolean hasOverride(Class<? extends ExpressionHandler> subclass, String method)
   {
      try {
         return !subclass.getMethod(method).getDeclaringClass().equals(ExpressionHandler.class);
   ...
   protected ExpressionHandler(Scip scipobj, String name, String desc, long precedence)
   {
      ...
      _has_simplify = hasOverride(subclass, "simplify");
      _has_compare = hasOverride(subclass, "compare");
      _has_print = hasOverride(subclass, "print");
      _has_parse = hasOverride(subclass, "parse");
      _has_bwdiff = hasOverride(subclass, "bwdiff");
      _has_fwdiff = hasOverride(subclass, "fwdiff");
      _has_bwfwdiff = hasOverride(subclass, "bwfwdiff");
      _has_inteval = hasOverride(subclass, "inteval");
      _has_estimate = hasOverride(subclass, "estimate");
      _has_initestimates = hasOverride(subclass, "initestimates");
      _has_reverseprop = hasOverride(subclass, "reverseprop");
      _has_hash = hasOverride(subclass, "hash");
      _has_curvature = hasOverride(subclass, "curvature");
      _has_monotonicity = hasOverride(subclass, "monotonicity");
      _has_integrality = hasOverride(subclass, "integrality");
      _has_getsymdata = hasOverride(subclass, "symdata");
      SWIGTYPE_p_SCIP scipptr = scipobj.getPtr();
      _objexprhdlr = createObjExprhdlr(scipptr);
      _exprhdlrptr = SCIPJNI.includeObjExprhdlr(scipptr, _objexprhdlr, 1);
   }
      ...
      ObjExprhdlr objexprhdlr = new ObjExprhdlr(scipptr, _name, _desc, _precedence, 1, 1, _has_simplify ? 1 : 0, _has_compare ? 1 : 0, _has_print ? 1 : 0, _has_parse ? 1 : 0, _has_bwdiff ? 1 : 0, _has_fwdiff ? 1 : 0, _has_bwfwdiff ? 1 : 0, _has_inteval ? 1 : 0, _has_estimate ? 1 : 0, _has_initestimates ? 1 : 0, _has_reverseprop ? 1 : 0, _has_hash ? 1 : 0, _has_curvature ? 1 : 0, _has_monotonicity ? 1 : 0, _has_integrality ? 1 : 0, _has_getsymdata ? 1 : 0) {
         ...
         public SCIP_Retcode scip_estimate(SWIGTYPE_p_SCIP scip, SWIGTYPE_p_SCIP_EXPR expr, SCIP_Interval localbounds, SCIP_Interval globalbounds, SWIGTYPE_p_double refpoint, long overestimate, double targetvalue, SWIGTYPE_p_double coefs, SWIGTYPE_p_double constant, SWIGTYPE_p_unsigned_int islocal, SWIGTYPE_p_unsigned_int success, SWIGTYPE_p_unsigned_int branchcand) {
            try {
               ...
               SCIPJNI.unsigned_int_array_setitem(success, 0, res.success ? 1 : 0);
   ...
   protected final Expression createExpressionInternal(Object exprdata, Expression[] children, ExpressionOwnerCreateCallback ownercreate) {
      ...
      return new Expression(SCIPJNI.createExpr(scip.getPtr(), _exprhdlrptr, exprdataptr, nchildren, childrenptr, ownercreate != null ? ownercreate.getFuncPtr() : null, ownercreate != null ? ownercreate.getDataPtr() : null));
   }
   ...
   protected static class Estimate {
      ...
      public Estimate(double[] coefs, double constant, boolean islocal, boolean success, boolean branchcand) {
         this.coefs = coefs;
