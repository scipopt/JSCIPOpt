...
public class SCIPJNIJNI {
  ...
  public final static native long new_SCIP_ImplintType_array(int jarg1);
  public final static native void delete_SCIP_ImplintType_array(long jarg1);
  public final static native int SCIP_ImplintType_array_getitem(long jarg1, int jarg2);
  public final static native void SCIP_ImplintType_array_setitem(long jarg1, int jarg2, int jarg3);
  ...
  public final static native int SCIP_IMPLINTTYPE_NONE_get();
  public final static native int SCIP_IMPLINTTYPE_WEAK_get();
  public final static native int SCIP_IMPLINTTYPE_STRONG_get();
  ...
  public final static native long createConsBasicPseudoboolean(long jarg1, String jarg2, long jarg3, int jarg4, long jarg5, long jarg6, int jarg7, long jarg8, long jarg9, long jarg10, double jarg11, long jarg12, double jarg13, double jarg14);
  ...
  public static int SwigDirector_ObjExprhdlr_scip_monotonicity(ObjExprhdlr jself, long scip, long expr, int childidx, long monotonicity) {
    return (jself.scip_monotonicity((scip == 0) ? null : new SWIGTYPE_p_SCIP(scip, false), (expr == 0) ? null : new SWIGTYPE_p_SCIP_EXPR(expr, false), childidx, (monotonicity == 0) ? null : new SWIGTYPE_p_SCIP_MONOTONE(monotonicity, false))).swigValue();
  }
  public static int SwigDirector_ObjExprhdlr_scip_integrality(ObjExprhdlr jself, long scip, long expr, long integrality) {
    return (jself.scip_integrality((scip == 0) ? null : new SWIGTYPE_p_SCIP(scip, false), (expr == 0) ? null : new SWIGTYPE_p_SCIP_EXPR(expr, false), (integrality == 0) ? null : new SWIGTYPE_p_SCIP_ImplintType(integrality, false))).swigValue();
  }
