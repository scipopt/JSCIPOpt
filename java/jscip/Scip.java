...
public class Scip
{
   ...
   public Constraint createConsPseudoboolean(String name, Variable[] linvars, double[] linvals, Variable[][] terms, double[] termvals, Variable indvar, double weight, boolean issoftcons, double lhs, double rhs)
   {
      ...
      SWIGTYPE_p_SCIP_CONS consptr = SCIPJNI.createConsBasicPseudoboolean(_scipptr, name, linvarsptr, nlinvars, linvalsptr, termsptr, nterms, ntermvarsptr, termvalsptr, (indvar != null) ? indvar.getPtr() : null, weight, issoftcons ? 1 : 0, lhs, rhs);
      assert(consptr != null);
   ...
   public Constraint createConsOrbitope(String name, Variable[][] vars, SCIP_OrbitopeType orbitopetype, boolean usedynamicprop, boolean resolveprop, boolean ismodelcons, boolean mayinteract, boolean checkpporbitope)
   {
      ...
      SWIGTYPE_p_SCIP_CONS consptr = SCIPJNI.createConsBasicOrbitope(_scipptr, name, varsptr, orbitopetype, nspcons, nblocks, /*usedynamicprop ? 1 : 0,*/ resolveprop ? 1 : 0, ismodelcons ? 1 : 0, mayinteract ? 1 : 0, checkpporbitope ? 1 : 0);
      assert(consptr != null);
   ...
   /** wraps SCIPcreateConsBasicOrbitope(); backwards compatibility overload */
   ...
   {
      return createConsOrbitope(name, vars, orbitopetype, usedynamicprop, resolveprop, ismodelcons, mayinteract, false);
   }
