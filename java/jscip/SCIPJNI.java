...
public class SCIPJNI {
  ...
  public static SWIGTYPE_p_SCIP_ImplintType new_SCIP_ImplintType_array(int nelements) {
    long cPtr = SCIPJNIJNI.new_SCIP_ImplintType_array(nelements);
    return (cPtr == 0) ? null : new SWIGTYPE_p_SCIP_ImplintType(cPtr, false);
  }

  public static void delete_SCIP_ImplintType_array(SWIGTYPE_p_SCIP_ImplintType ary) {
    SCIPJNIJNI.delete_SCIP_ImplintType_array(SWIGTYPE_p_SCIP_ImplintType.getCPtr(ary));
  }

  public static SCIP_ImplintType SCIP_ImplintType_array_getitem(SWIGTYPE_p_SCIP_ImplintType ary, int index) {
    return SCIP_ImplintType.swigToEnum(SCIPJNIJNI.SCIP_ImplintType_array_getitem(SWIGTYPE_p_SCIP_ImplintType.getCPtr(ary), index));
  }

  public static void SCIP_ImplintType_array_setitem(SWIGTYPE_p_SCIP_ImplintType ary, int index, SCIP_ImplintType value) {
    SCIPJNIJNI.SCIP_ImplintType_array_setitem(SWIGTYPE_p_SCIP_ImplintType.getCPtr(ary), index, value.swigValue());
  }
  ...
  public static SWIGTYPE_p_SCIP_CONS createConsBasicOrbitope(SWIGTYPE_p_SCIP scip, String name, SWIGTYPE_p_p_p_SCIP_VAR vars, SCIP_OrbitopeType orbitopetype, int nspcons, int nblocks, long resolveprop, long ismodelcons, long mayinteract, long checkpporbitope) {
    long cPtr = SCIPJNIJNI.createConsBasicOrbitope(SWIGTYPE_p_SCIP.getCPtr(scip), name, SWIGTYPE_p_p_p_SCIP_VAR.getCPtr(vars), orbitopetype.swigValue(), nspcons, nblocks, resolveprop, ismodelcons, mayinteract, checkpporbitope);
    return (cPtr == 0) ? null : new SWIGTYPE_p_SCIP_CONS(cPtr, false);
  }
