...
static SCIP_IMPLINTTYPE *new_SCIP_ImplintType_array(int nelements) { 
  return new SCIP_IMPLINTTYPE[nelements](); 
}

static void delete_SCIP_ImplintType_array(SCIP_IMPLINTTYPE *ary) { 
  delete [] ary; 
}

static SCIP_IMPLINTTYPE SCIP_ImplintType_array_getitem(SCIP_IMPLINTTYPE *ary, int index) {
    return ary[index];
}
static void SCIP_ImplintType_array_setitem(SCIP_IMPLINTTYPE *ary, int index, SCIP_IMPLINTTYPE value) {
    ary[index] = value;
}
...
SCIP_RETCODE SwigDirector_ObjExprhdlr::scip_monotonicity(SCIP *scip, SCIP_EXPR *expr, int childidx, SCIP_MONOTONE *monotonicity) {
  SCIP_RETCODE c_result = SwigValueInit< SCIP_RETCODE >() ;
  jint jresult = 0 ;
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  ...
  jlong jexpr = 0 ;
  jint jchildidx  ;
  jlong jmonotonicity = 0 ;
  
  if (!swig_override[19]) {
    return scip::ObjExprhdlr::scip_monotonicity(scip,expr,childidx,monotonicity);
  }
  swigjobj = swig_get_self(jenv);
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    *((SCIP **)&jscip) = (SCIP *) scip; 
    *((SCIP_EXPR **)&jexpr) = (SCIP_EXPR *) expr; 
    jchildidx = (jint) childidx;
    *((SCIP_MONOTONE **)&jmonotonicity) = (SCIP_MONOTONE *) monotonicity; 
    jresult = (jint) jenv->CallStaticIntMethod(Swig::jclass_SCIPJNIJNI, Swig::director_method_ids[26], swigjobj, jscip, jexpr, jchildidx, jmonotonicity);
    jthrowable swigerror = jenv->ExceptionOccurred();
    if (swigerror) {
      Swig::DirectorException::raise(jenv, swigerror);
    }
...
SCIP_RETCODE SwigDirector_ObjExprhdlr::scip_integrality(SCIP *scip, SCIP_EXPR *expr, SCIP_IMPLINTTYPE *integrality) {
  SCIP_RETCODE c_result = SwigValueInit< SCIP_RETCODE >() ;
  jint jresult = 0 ;
  JNIEnvWrapper swigjnienv(this) ;
  JNIEnv * jenv = swigjnienv.getJNIEnv() ;
  ...
  if (swigjobj && jenv->IsSameObject(swigjobj, NULL) == JNI_FALSE) {
    *((SCIP **)&jscip) = (SCIP *) scip; 
    *((SCIP_EXPR **)&jexpr) = (SCIP_EXPR *) expr; 
    *((SCIP_IMPLINTTYPE **)&jintegrality) = (SCIP_IMPLINTTYPE *) integrality; 
...
void SwigDirector_ObjExprhdlr::swig_connect_director(JNIEnv *jenv, jobject jself, jclass jcls, bool swig_mem_own, bool weak_global) {
  static struct {
    ...
    {
      "scip_integrality", "(Ljscip/SWIGTYPE_p_SCIP;Ljscip/SWIGTYPE_p_SCIP_EXPR;Ljscip/SWIGTYPE_p_SCIP_ImplintType;)Ljscip/SCIP_Retcode;", NULL 
    },
    {
...
SWIGEXPORT jlong JNICALL Java_jscip_SCIPJNIJNI_new_1SCIP_1ImplintType_1array(JNIEnv *jenv, jclass jcls, jint jarg1) {
  jlong jresult = 0 ;
  int arg1 ;
  SCIP_IMPLINTTYPE *result = 0 ;
  
  (void)jenv;
  (void)jcls;
  arg1 = (int)jarg1; 
  result = (SCIP_IMPLINTTYPE *)new_SCIP_ImplintType_array(arg1);
  *(SCIP_IMPLINTTYPE **)&jresult = result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_jscip_SCIPJNIJNI_delete_1SCIP_1ImplintType_1array(JNIEnv *jenv, jclass jcls, jlong jarg1) {
  SCIP_IMPLINTTYPE *arg1 = (SCIP_IMPLINTTYPE *) 0 ;
  
  (void)jenv;
  (void)jcls;
  arg1 = *(SCIP_IMPLINTTYPE **)&jarg1; 
  delete_SCIP_ImplintType_array(arg1);
}


SWIGEXPORT jint JNICALL Java_jscip_SCIPJNIJNI_SCIP_1ImplintType_1array_1getitem(JNIEnv *jenv, jclass jcls, jlong jarg1, jint jarg2) {
  jint jresult = 0 ;
  SCIP_IMPLINTTYPE *arg1 = (SCIP_IMPLINTTYPE *) 0 ;
  int arg2 ;
  SCIP_IMPLINTTYPE result;
  
  (void)jenv;
  (void)jcls;
  arg1 = *(SCIP_IMPLINTTYPE **)&jarg1; 
  arg2 = (int)jarg2; 
  result = (SCIP_IMPLINTTYPE)SCIP_ImplintType_array_getitem(arg1,arg2);
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT void JNICALL Java_jscip_SCIPJNIJNI_SCIP_1ImplintType_1array_1setitem(JNIEnv *jenv, jclass jcls, jlong jarg1, jint jarg2, jint jarg3) {
  SCIP_IMPLINTTYPE *arg1 = (SCIP_IMPLINTTYPE *) 0 ;
  int arg2 ;
  SCIP_IMPLINTTYPE arg3 ;
  
  (void)jenv;
  (void)jcls;
  arg1 = *(SCIP_IMPLINTTYPE **)&jarg1; 
  arg2 = (int)jarg2; 
  arg3 = (SCIP_IMPLINTTYPE)jarg3; 
  SCIP_ImplintType_array_setitem(arg1,arg2,arg3);
}
...
SWIGEXPORT jint JNICALL Java_jscip_SCIPJNIJNI_SCIP_1IMPLINTTYPE_1NONE_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  SCIP_ImplintType result;
  
  (void)jenv;
  (void)jcls;
  result = (SCIP_ImplintType)SCIP_IMPLINTTYPE_NONE;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_jscip_SCIPJNIJNI_SCIP_1IMPLINTTYPE_1WEAK_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  SCIP_ImplintType result;
  
  (void)jenv;
  (void)jcls;
  result = (SCIP_ImplintType)SCIP_IMPLINTTYPE_WEAK;
  jresult = (jint)result; 
  return jresult;
}


SWIGEXPORT jint JNICALL Java_jscip_SCIPJNIJNI_SCIP_1IMPLINTTYPE_1STRONG_1get(JNIEnv *jenv, jclass jcls) {
  jint jresult = 0 ;
  SCIP_ImplintType result;
  
  (void)jenv;
  (void)jcls;
  result = (SCIP_ImplintType)SCIP_IMPLINTTYPE_STRONG;
  jresult = (jint)result; 
  return jresult;
}
...
SWIGEXPORT jint JNICALL Java_jscip_SCIPJNIJNI_ObjExprhdlr_1scip_1integrality(JNIEnv *jenv, jclass jcls, jlong jarg1, jobject jarg1_, jlong jarg2, jlong jarg3, jlong jarg4) {
  ...
  SCIP *arg2 = (SCIP *) 0 ;
  SCIP_EXPR *arg3 = (SCIP_EXPR *) 0 ;
  SCIP_IMPLINTTYPE *arg4 = (SCIP_IMPLINTTYPE *) 0 ;
  SCIP_RETCODE result;
...
SWIGEXPORT jlong JNICALL Java_jscip_SCIPJNIJNI_createConsBasicPseudoboolean(JNIEnv *jenv, jclass jcls, jlong jarg1, jstring jarg2, jlong jarg3, jint jarg4, jlong jarg5, jlong jarg6, jint jarg7, jlong jarg8, jlong jarg9, jlong jarg10, jdouble jarg11, jlong jarg12, jdouble jarg13, jdouble jarg14) {
  jlong jresult = 0 ;
  SCIP *arg1 = (SCIP *) 0 ;
  char *arg2 = (char *) 0 ;
  SCIP_VAR **arg3 = (SCIP_VAR **) 0 ;
  ...
  arg13 = (double)jarg13; 
  arg14 = (double)jarg14; 
  result = (SCIP_CONS *)createConsBasicPseudoboolean(arg1,(char const *)arg2,arg3,arg4,arg5,arg6,arg7,arg8,arg9,arg10,arg11,arg12,arg13,arg14);
  *(SCIP_CONS **)&jresult = result; 
  if (arg2) jenv->ReleaseStringUTFChars(jarg2, (const char *)arg2);
  return jresult;
}
