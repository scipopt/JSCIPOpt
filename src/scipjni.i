...
%{
   ...
   SCIP_CONS* createConsBasicPseudoboolean(SCIP* scip, const char* name, SCIP_VAR** linvars, int nlinvars, SCIP_Real* linvals, SCIP_VAR*** terms, int nterms, int* ntermvars, SCIP_Real* termvals, SCIP_VAR* indvar, SCIP_Real weight, SCIP_Bool issoftcons, SCIP_Real lhs, SCIP_Real rhs)
   {
      SCIP_CONS* cons;
   ...
   SCIP_CONS* createConsBasicOrbitope(SCIP* scip, const char* name, SCIP_VAR*** vars, SCIP_ORBITOPETYPE orbitopetype, int nspcons, int nblocks, SCIP_Bool resolveprop, SCIP_Bool ismodelcons, SCIP_Bool mayinteract, SCIP_Bool checkpporbitope)
   {
      SCIP_CONS* cons;

      SCIP_CALL_ABORT( SCIPcreateConsBasicOrbitope(scip, &cons, name, vars, orbitopetype, nspcons, nblocks, resolveprop, ismodelcons, checkpporbitope) );
...
%array_functions( SCIP_IMPLINTTYPE, SCIP_ImplintType_array )
...
typedef struct SCIP_ExprData {
   jobject jobj;
%proxycode %{
   public void setSwigCMemOwn(boolean cMemOwn) {
      swigCMemOwn = cMemOwn;
   }
%}
} SCIP_EXPRDATA;
...
public:
   ...
   virtual SCIP_RETCODE scip_monotonicity(SCIP* scip, SCIP_EXPR* expr, int childidx, SCIP_MONOTONE* monotonicity);
   virtual SCIP_RETCODE scip_integrality(SCIP* scip, SCIP_EXPR* expr, SCIP_IMPLINTTYPE* integrality);
